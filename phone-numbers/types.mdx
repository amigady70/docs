...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with clevercallai.com: dedicated numbers, SIP integration, and Caller ID"
---

clevercallai.com lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from clevercallai.com.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from clevercallai.com's AI.

...
The CleverCalls API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your CleverCalls account at [https://app.CleverCalls.ai](https://app.CleverCalls.ai)
...
```bash
curl -X GET "https://api.CleverCalls.ai/api/user/campaigns" \

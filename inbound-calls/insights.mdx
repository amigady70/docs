...
After an inbound call, clevercall.com provides transcripts, analytics, and possible automation triggers.
...
- In your clevercall.com dashboard, go to **Calls** or **History**.

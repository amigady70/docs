...
After an inbound call, CleverCalls.ai provides transcripts, analytics, and possible automation triggers.
...
- In your CleverCalls.ai dashboard, go to **Calls** or **History**.

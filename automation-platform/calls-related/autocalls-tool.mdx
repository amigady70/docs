---
title: "CleverCalls Tool"
icon: "phone"
description: "Learn how to use CleverCalls triggers and actions in your AI calling flows"
---

# CleverCalls Tool

The CleverCalls tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the CleverCalls tool prominently displayed at the top of the
...
![CleverCalls Call Ended Trigger](/resources/CleverCalls-trigger.jpg)
...
![CleverCalls Action](/resources/CleverCalls-action.jpg)
